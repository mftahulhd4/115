<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Tambah Data Pendidikan Baru') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('master.pendidikan.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_pendidikan" class="block mt-1 w-full" type="text" name="nama_pendidikan" :value="old('nama_pendidikan')" required autofocus />
