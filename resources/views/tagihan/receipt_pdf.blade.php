...
<head>
    ...
    <title>Kuitansi - {{ $tagihan->jenisTagihan->nama_jenis_tagihan }} - {{ optional($tagihan->santri)->nama_santri }}</title>
    <style>
        ...
        <div class="content">
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td>: {{ $tagihan->status_pembayaran == 'Lunas' ? \Carbon\Carbon::parse($tagihan->updated_at)->isoFormat('dddd, D MMMM Y') : 'Belum Lunas' }}</td>
                </tr>
            </table>
