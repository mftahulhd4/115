                ...
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('tagihan.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_tagihan" class="block mt-1 w-full" type="text" name="nama_tagihan" :value="old('nama_tagihan')" required autofocus placeholder="Contoh: SPP Bulanan, Uang Loundry, dll." />
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" class="block mt-1 w-full border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm" rows="3" placeholder="Catatan tambahan untuk jenis tagihan ini...">{{ old('deskripsi') }}</textarea>
                            <x-input-error :messages="$errors->get('deskripsi')" class="mt-2" />
                        </div>
                        
                        <div class="flex items-center justify-end mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            <a href="{{ route('tagihan.index') }}" class="text-sm text-gray-700 dark:text-gray-300 underline hover:no-underline">
                                Batal
                            </a>
