...
<head>
    <meta charset="UTF-8">
    <title>Cetak Surat Izin - {{ optional($perizinan->santri)->nama_lengkap }}</title>
    <style>
        /* Gaya ini meniru tampilan PDF surat izin */
        body { 
...
<body>
    <div class="page">
        ...
        <div class="surat-title">
            ...
            <span>Nomor: SK.NA/S/0{{ $perizinan->id }}/{{ \Carbon\Carbon::parse($perizinan->created_at)->format('m/Y') }}</span>
        </div>
        ...
        <div class="penutup">
            <p>Demikian surat izin ini kami buat untuk dapat dipergunakan sebagaimana mestinya. Atas perhatian dan kerjasamanya kami sampaikan terima kasih.</p>
        </div>
