...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('tagihan')->name('tagihan.')->group(function () {
        ...
        Route::get('/santri-bill/{tagihan}', [DaftarTagihanController::class, 'showSantriBill'])->name('show_santri_bill');
        Route::get('/santri-bill/{tagihan}/edit', [DaftarTagihanController::class, 'editSantriBill'])->name('edit_santri_bill');
        Route::put('/santri-bill/{tagihan}', [DaftarTagihanController::class, 'updateSantriBill'])->name('update_santri_bill');
        Route::delete('/santri-bill/{tagihan}', [DaftarTagihanController::class, 'destroySantriBill'])->name('destroy_santri_bill');
        Route::get('/receipt/{tagihan}/pdf', [DaftarTagihanController::class, 'pdfReceipt'])->name('pdf_receipt');
        Route::get('/receipt/{tagihan}/print', [DaftarTagihanController::class, 'printReceipt'])->name('print_receipt');
    });
